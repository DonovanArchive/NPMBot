...
export default class ExtraHandlers {
	...
	async checkPermissions(client: NPMBot, msg: ExtendedMessage, cmd: Command) {
	...
	async runHelp(client: NPMBot, msg: ExtendedMessage, cmd: Command) {
	...
	async runInvalidUsage(client: NPMBot, msg: ExtendedMessage, cmd: Command, err: CommandError<"ERR_INVALID_USAGE">) {
